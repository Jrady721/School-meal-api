...
// -----------------------------------------------
$str = <<<HTML
<td><b>keyword :</b>1 gram but <5 grams</td>
HTML;
$dom->load($str);
assert($dom->find('td', 0)->innertext==='<b>keyword :</b>1 gram but <5 grams');
assert($dom->find('td', 0)->plaintext==='keyword :1 gram but <5 grams');
assert($dom==$str);
...
$str = <<<HTML
<td><b>keyword :</b>1 gram but5< grams</td>
HTML;
$dom->load($str);
assert($dom->find('td', 0)->innertext==='<b>keyword :</b>1 gram but5< grams');
assert($dom->find('td', 0)->plaintext==='keyword :1 gram but5< grams');
assert($dom==$str);
