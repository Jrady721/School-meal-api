...
// -----------------------------------------------
$str = <<<HTML
<div-keyword id="1">text</div-keyword>
HTML;
$dom->load($str);
$es = $dom->find('div-keyword');
assert(count($es)==1);
assert($es[0]->id=='1');
// -----------------------------------------------
$str = <<<HTML
